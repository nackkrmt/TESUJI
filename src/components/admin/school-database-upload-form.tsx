...
export function SchoolDatabaseUploadForm() {
  ...
  function uploadSelectedFile() {
    ...
    startTransition(async () => {
      ...
      const response = await fetch("/admin/database/school/upload", {
        method: "POST",
        body: formData,
      });
  ...
  return (
    <div className="rounded-md border border-[#27345b] bg-[#0a1128] p-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-sm font-semibold text-white">Upload SCHOOL</p>
